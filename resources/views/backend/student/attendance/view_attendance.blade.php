...
<div class="col-12 p-10">
            <div class="form-group">
                <div class="col-sm-12">
                    <h4 class="text-center font-weight-bold font-italic mt-3">Batch Wise Student Attendacne View</h4>
                </div>
  ...
  $('#elem').toggle('swing');
    ...
    $('#date').on('change',function(){
       ...
       var date = $(this).val();
        ...
        $.ajax({
          url:"{{ route('View_Attendance_Date') }}",
          type:"GET",
          data:{class_id:class_id,batch_id:batch_id,courch_id:courch_id,date:date},
