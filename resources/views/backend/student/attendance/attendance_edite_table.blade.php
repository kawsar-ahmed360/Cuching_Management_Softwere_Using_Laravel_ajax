...
<div class="table-responsive p-1">
 ...
 {{--                            <fieldset>
    ...
    <input type="radio" name="radio-1" id="radio-2">
                ...
                <input type="radio" name="attendance[{{ $s->id }}]" {{ $s->attendance==1?'checked':"" }} id="radio-1" value="1">
                <label for="radio-2">Absense</label>
                <input type="radio" name="attendance[{{ $s->id }}]" id="radio-2" {{ $s->attendance==2?"checked":"" }} value="2">
