...
@section('content')
                ...
                <form action="{{ route('StudentAttendanceSave') }}" method="post" >
                @csrf  
<div class="col-12 p-10">
            <div class="form-group">
                <div class="col-sm-12">
                    <h4 class="text-center font-weight-bold font-italic mt-3">Batch Wise Student Attendacne Form</h4>
                </div>
  ...
  $('#elem').toggle('swing');
    ...
    $('#batch_id').on('change',function(){
       ...
       var courch_id = $('#courch_id').val();
        ...
        $.ajax({
          url:"{{ route('allstudentShowattend') }}",
          type:"GET",
