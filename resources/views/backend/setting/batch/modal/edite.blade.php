<div id="BatchModalEdite" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content"  style="background: silver; color:white">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Edite Batch</h4>
      </div>
...
@endif
                      <form action="{{ route('BatchListAjaxEdite') }}" method="post" id="BatchEdite" enctype="multipart/form-data">
                        @csrf
