<div id="EditeModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content"  style="background: silver; color:white">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Edite Courch</h4>
      </div>
...
@endif
                      <form action="{{ route('CourchListAjaxEdite') }}" method="post" id="CourchEdite" enctype="multipart/form-data">
                        @csrf
